  ...
  render() {
    return(
      <div>
        ...
        <h3>Patna</h3>
        <img id="patnaimage1" src="/images/patnaimage1.jpg" alt="Patna during British Occupation" width="390" height="300"/>
        <img id="patnaimage3" src="/images/patnaimage3.jpg" alt="Women surround Religious Monument" width="300" height="370"/>
        <img id="patnaimage4" src="/images/patnaimage4.jpg" alt="Map of Patna" width="370" height="300"/>
        ...
        <img id="sherghatiimage1" src="/images/sherghatiimage1.jpg" alt="Picture of Sherghati's landscape" width="350" height="300"/>
        <img id="sherghatiimage2" src="/images/sherghatiimage2.jpg" alt="Picture of Shergotty meteorite" width="350" height="330"/>
        <img id="sherghatiimage3" src="/images/sherghatiimage3.jpg" alt="Picture of a drawing of a hills in Sherghati" width="350" height="300"/>
