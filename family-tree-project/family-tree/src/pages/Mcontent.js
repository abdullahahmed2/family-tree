        ...
        <div className="box">
          ...
          <form method='post' id='register' action=''>
              ...
              <div className="name">
                ...
                <input type='text' name='Firstname' id='Fname' maxLength={10} placeholder='First name' required/><br/><br/>

                <input type='text' name='Middlename' id='Mname' maxLength={10} placeholder='Middle name' required/><br/><br/>
